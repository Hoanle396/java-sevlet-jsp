                ...
                <div class="container">
                    <div class="about-content">
                        <div class="row animate-box">
                            <div class="col-md-6">
                                <div class="desc">
                                    <h3>Giới Thiệu Về HKT</h3>
                                    <p>Hệ thống giày HKTSHOP chuyên thiết kế và kinh doanh các mặt hàng giày dép cho giới trẻ, là cấu nối cho bạn trẻ cả nước tiếp cận với xu hướng thời trang giày trên thế giới. "Chúng tôi mang đến sự khác biệt!" - Cùng với xu hướng thời trang của thế giới Hệ thống HKTSHOP đã và đang không ngừng đổi mới để mang đến cho các bản trẻ các mẫu giày thời trang độc đáo, mới lạ, để tiên phong cho một phong cách thời trang mới, một phong cách biểu tượng cho giới trẻ trên cả nước.</p> 
                                    <p>Vì thế HKTSHOP đang dần trở thành một cái tên quen thuộc với tất cả các bạn trẻ với những phong cách thời trang hoàn toàn mới lạ, khẳng định cá tính của chính mình.</p>
                                    <p style="font-style: italic">Sự hài lòng của các bạn chính là mục tiêu phấn đấu của chúng tôi.</p>
                                </div>
                                
                            </div>
                            <div class="col-md-6">
                                <img class="img-responsive" src="https://cdn.shortpixel.ai/client/q_lossless,ret_img,w_800,h_600/https://shopgiayreplica.com/wp-content/uploads/2020/10/Jordan-1-Mid-SE-Multi-Color-800x600.jpg" alt="about">
                            </div>
                        </div>
                    </div>
